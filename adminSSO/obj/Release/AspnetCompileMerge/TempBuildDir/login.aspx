    ...
    <form id="form1" runat="server">
        ...
        <div class="loginArea">
            ...
            <div class="formBox" id="queryTable">
                <p class="inputBox">
                    <input type="text" runat="server" class="LoginText" value="" runat="server" id="txtCustomerCode" placeholder="请输入商户编码" />
                </p>
                <p class="inputBox">
                    <input type="text" runat="server" class="LoginText" value="" id="txtUsername" runat="server" placeholder="请输入用户名" />
                </p>
                <p class="inputBox pwBox">
                    <input type="password" name="password" runat="server" class="LoginText" id="txtPassword" runat="server" placeholder="请输入密码" /><%--<span class="forgetPw">忘记密码</span>--%>
                </p>
                <p class="loginBtnBox">
